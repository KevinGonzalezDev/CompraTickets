...
@section('content')
        ...
        <div class = 'Margin P0' >
            ...
            <table width ='100%' class = ' DetallePrecios'>
				...
				<span class = 'fact' style = 'display:none;'>{{$datos['info2'][0]->idfacturacion}}</span>
                    ...
                    <td>
                        <table width ='100%'>
                            ...
                            <tr>
                                <td style = 'border:0px;'>
                                   <div class='form-check form-check-inline'>
                                        <input class='ValorBoleta form-check-input' type='checkbox' name = 'pase[]' id='estadoA' value='2' >
