...
@section('content')
        ...
        <input name="description"   type="hidden"  value="PAYU"  >
        ...
        <input name="responseUrl"    type="hidden"  value="http://tickets.cxsummit.com.co/CompraTickets/public/DatosPayU/{{$datos['info'][0]->id}}" >
        <input name="confirmationUrl"    type="hidden"  value="http://tickets.cxsummit.com.co/CompraTickets/public/DatosPayU/{{$datos['info'][0]->id}}" >
