                                                ...
                                                <tr>
                                                    <td style = 'text-align:center;' colspan = '3'>
														<div class='form-check form-check-inline'>
															<input class='form-check-input' type='radio' name = 'tallerxx1' id='estadoDxx' value='1' >
															<label class='form-check-label' for='estadoDxx' style = 'font-weight:500;'>
                    ...
                    <div style = 'padding-left:10%;padding-right: 10%;'>
                        <table width ='100%' class = 'Form ' style = 'background-color:white;'>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td style = 'padding-left:30px;'>
                                    <p>Email Facturación<span class = 'indicador'>*</span></p>
